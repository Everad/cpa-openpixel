  ...
  _createClass(Pixel, [{
    ...
    value: function getAttribute() {
      ...
      return {
        ...
        // user agent
        sid1: function sid1(key) {
          return Cookie.getUtm(key);
        },
        // get the utm source
        sid2: function sid2(key) {
          return Cookie.getUtm(key);
        },
        // get the utm medium
        sid3: function sid3(key) {
          return Cookie.getUtm(key);
        },
        // get the utm term
        sid4: function sid4(key) {
          return Cookie.getUtm(key);
        },
        // get the utm concent
        sid5: function sid5(key) {
          return Cookie.getUtm(key);
        },
        // get the utm campaign
        ev_campaign: function ev_campaign(key) {
          return Cookie.getUtm(key);
        } // get the utm campaign
...
}(window, document, window["initial_track"], "initial_track", "http://extrack.cpa2.zapasnoydomen.com/api/v1/tracking/pixel.png", 1));
